...
BREATHING_SPEED = 0.2  # Control the speed of the breathing effect
...
try:
    ...
    while True:
        ...
        # Breathing effect, from -1 to 1 and then back to -1, for the ripple
        wave_factor = (math.cos(t * BREATHING_SPEED) + 1) / 2
        ...
        for matrix_num in range(TOTAL_MATRICES):
            ...
            for y in range(MATRIX_SIZE):
                for x in range(MATRIX_SIZE):
                    ...
                    brightness = (math.sin(t * SPEED_FACTOR - distance * wave_factor) + 1) / 2
