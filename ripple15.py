...
SPEED_FACTOR = 1.7  # Increases the speed of the animation
COLOR_CHANGE_SPEED = 0.5  # Controls the speed of color change
NOISE_TRANSITION_SPEED = 0.02  # Controls the speed of the noise transition for each LED
        ...
        for matrix_num in range(TOTAL_MATRICES):
            ...
            for y in range(MATRIX_SIZE):
                for x in range(MATRIX_SIZE):
                    ...
                    # Use the absolute value of the sine function for a breathing effect
                    brightness = abs(math.sin(t - distance))  # oscillates between 0 and 1
