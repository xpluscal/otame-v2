...
SPEED_FACTOR = 1.0  # Adjust the speed of the animation
...
try:
    ...
    while True:
        ...
        # Use a sinusoidal motion to create a breathing effect for the ripple
        ripple_effect = math.sin(t)
        ...
        for matrix_num in range(TOTAL_MATRICES):
            ...
            for y in range(MATRIX_SIZE):
                for x in range(MATRIX_SIZE):
                    ...
                    brightness = (math.sin(t - distance * ripple_effect) + 1) / 2  # produces values between 0 and 1
